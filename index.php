...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
    <img src="images/logo.jpg" width="45" height="40" class="d-inline-block align-top" alt="">
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Bank Of Kolkata</h4>
     ...
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/1.1.jpg" alt="First slide" style="max-height: 250px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/2.2.jpg" alt="Second slide" style="max-height: 250px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/3.3.jpg" alt="Third slide" style="max-height: 250px">
          </div>
